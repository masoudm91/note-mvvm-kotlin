...
import com.example.noteapp.ui.main.activity.MainActivity
import com.example.noteapp.R
import com.example.noteapp.databinding.FragmentSingleNoteBinding
...
class SingleNoteFragment : Fragment() {
                ...
                if (this.titleEdtx.text.isNullOrBlank()) {
                    ...
                    if (this.noteEdtx.text.isNullOrBlank()) {
                        ...
                        Navigation.findNavController(view)
                            .navigate(R.id.action_singleNoteFragment_to_homeFragment)
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        if (pinned)
            ...
            item.icon =
                ContextCompat.getDrawable(requireActivity(), R.drawable.ic_outline_push_pin_24)
    }
